...
public class DynamicClientFT extends BaseUnitTestCase {
    ...
    public AccountSoapService creatClient() {
        ...
        outProps.put("passwordCallbackClass", "com.cmmi.test.soap.oauth.ClientOauthCertCallback");
        ...
        inProps.put("passwordCallbackClass", "com.cmmi.test.soap.oauth.ClientOauthCertCallback");
